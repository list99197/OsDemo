...
public class MemoryBlockPane extends StackPane {
	private Rectangle rectangle;//小方格
	  ...
	  private void initializeListener() {
	    setOnMouseEntered(new EventHandler<MouseEvent>()
	        {
	          public void handle(MouseEvent event) {
	        	  MemoryBlockPane.this.setEffect(MemoryBlockPane.this.dropShadow);
	          }
	        });
	    ...
	    setOnMouseExited(new EventHandler<MouseEvent>()
	        {
	          public void handle(MouseEvent event) {
	        	  MemoryBlockPane.this.setEffect(null);
	          }
	        });
	  }
	  ...
	  public void setUsed() {
	    this.status = 1;
	    this.rectangle.setFill(Color.rgb(168, 247, 192));
	  }
